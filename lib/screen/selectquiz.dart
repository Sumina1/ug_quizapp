...
import 'package:ug_quizapp/repository/fetechapi.dart';
import 'package:ug_quizapp/screen/startquiz.dart';
                          ...
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) => StartQuiz(
                                      slug: snapshot.data.data.all[index].slug,
                          ...
                          child: Container(
                              ...
                              child: Center(
                                ...
                                children: [
                                  Image.network('$url'),
                                  Text(
                                    '${snapshot.data.data.all[index].name}',
